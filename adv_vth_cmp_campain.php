            ...
            <div class="row">
				...
				<div class="col-md-10">
                	<div class="panel panel-default">
                        <div class="panel-heading">Advertiser With Completed Campaign</div>
                        <div class="panel-body">
                        
                        	<form   method="post" action="adv_completed_campaign_download.php" >
...
function display()
{
	 ...
	 if(g != "" && h != "")
	 {
		 var url="adv_completed_campaign.php?da="+g+"&te="+h;
