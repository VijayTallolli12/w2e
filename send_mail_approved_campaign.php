...
$camp_id=$_GET['id'];
		...
		$sql="SELECT a.adv_date,a.adv_name,a.adv_email,a.adv_contact,b.camp_id,b.camp_art,
		b.camp_title,b.camp_end_date,b.camp_start_date,b.company,b.camp_no_cars 
		...
		AND b.camp_active_status='0' AND b.camp_id='$camp_id'";
						...
						http://wrap2earn.technoclock.com/  on $adv_date has been approved
						<br>
						<br>
						...
						need answering please get in touch with us on dilip@luculent.
						in or 9448501206 and a Wrap2Earn representative will be 
