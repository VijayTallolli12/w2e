...
<br><table class="table table-bordered order-table table" id="disp">
								...
								$sql="select * from cust_advertiser_info as a, cust_campaign_details as b where (b.camp_status!='0'  OR b.camp_active_status!='0' )
								AND a.adv_id = b.camp_adv_id limit $start,$limit ";	
                                ...
                                <tbody>
                                  <tr>
									...
									<td><a href="add_to_pay.php?camp_id=<?php echo $row['camp_id']; ?>">Click To Pay</a></td>
				  ...
				  ?>
							   ...
							   <ul class="pagination pagination-lg">
								<?php
								$rows=mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from cust_advertiser_info as a, cust_campaign_details as b where (b.camp_status!='0'  OR b.camp_active_status!='0' )
								AND a.adv_id = b.camp_adv_id"));
