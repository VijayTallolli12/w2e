...
<br><table class="table table-bordered order-table table">
	...
	SUM(a.driv_camp_dist) as driv_camp_dist  FROM cust_driver_camp_details 
					as a ,cust_drivers as b , cust_campaign_details as c where a.driv_camp_id = c.camp_id AND a.driv_id = b.driv_id group by a.driv_id limit $start,$limit";	
                                ...
                                <tbody>
                                  <tr>
									...
									<td><a href="driver_payment_details_viewmore.php?driv_id=<?php echo $row['driv_id']; ?>">View More</a> </td>
								...
								<?php
								$rows=mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT a.driv_id,b.driv_name,b.driv_email,driv_contact,c.company,c.camp_title,SUM(a.driv_camp_earn) 
								as driv_earn FROM cust_driver_camp_details 
           ...
           <a href="driver_payment_details_download.php" class="btn btn-purple btn-md">Download</a>
