        ...
        <div class="warper container-fluid">
             ...
             <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading"> Active Campaign</div>
...
<br><table class="table table-bordered order-table table">
							...
							b.camp_end_date,b.camp_duration,coalesce(sum( d.driv_impression),0) as impression,coalesce(sum( d.driv_camp_dist),0) as driv_camp_dist
						...
						AND b.camp_active_status='1' AND  c.active_or_inactive='2' AND  b.camp_end_date >= '$myDate' group by b.camp_id limit $start,$limit";
								...
								<?php
								$rows=mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT a.adv_name,a.adv_email,a.adv_contact,b.camp_id,b.camp_title,b.camp_start_date,
							b.camp_end_date,b.camp_duration,coalesce(sum( d.driv_impression),0) as impression
						from cust_advertiser_info a inner join  cust_campaign_details b on a.adv_id=b.camp_adv_id inner join 
						cust_vinyler_dashboard c on b.camp_id=c.vd_camp_id left join cust_driver_camp_details as d on b.camp_id = d.driv_camp_id
						where b.camp_status='0'
						AND b.camp_active_status='1' AND  c.active_or_inactive='2' AND  b.camp_end_date >= '$myDate' group by d.driv_camp_id"));
