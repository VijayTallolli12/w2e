        ...
        <div class="warper container-fluid">
             ...
             <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Total Number of Completed Campaigns Builder</div>
...
<br><table class="table table-bordered order-table table">
								...
								a.camp_art !='' AND a.camp_vinyl_pattern !='' AND a.camp_veh_type !='') limit $start,$limit";	
           ...
           <a href="completd_campaign_profile_download.php" class="btn btn-purple btn-md">Download</a>
