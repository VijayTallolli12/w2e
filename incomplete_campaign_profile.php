        ...
        <div class="warper container-fluid">
             ...
             <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Total Number of Incomplete Campaigns Profile</div>
...
<br><table class="table table-bordered order-table table">
								...
								a.camp_art='' OR a.camp_vinyl_pattern='' OR a.camp_veh_type='') limit $start,$limit";		
						...
						$no=$start;
							 ...
							 <ul class="pagination pagination-lg">
								<?php
								$rows=mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT *  FROM cust_campaign_details AS a , cust_advertiser_info as b WHERE (a.camp_adv_id = b.adv_id) AND 
								(a.company='' OR a.company_url='' OR a.camp_title='' OR a.company_desc='' OR a.camp_objective='' OR a.camp_category='' OR a.camp_no_cars='' 
								OR a.camp_start_date='' OR a.camp_duration='' OR a.camp_end_date='' OR a.camp_amount='' OR a.camp_city='' OR a.camp_from='' OR a.camp_logo='' OR
           ...
           <a href="incomplete_campaign_profile_download.php" class="btn btn-purple btn-md">Download</a>
