        ...
        <div class="warper container-fluid">
             ...
             <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Driver Active With Available Campaigns</div>
...
<br><table class="table table-bordered order-table table">
								 ...
								 <?php 
									...
									$myDate = date('Y/m/d');
						$sql="SELECT * FROM cust_campaign_details as b, cust_vinyler_dashboard as c , cust_drivers as d  where 
								b.camp_id=d.driv_camp_id AND b.camp_status='0' 
								AND b.camp_active_status='1' AND c.active_or_inactive='2' AND c.vd_camp_id=b.camp_id AND
								b.camp_end_date >= '$myDate' limit $start,$limit";
							...
							<ul class="pagination pagination-lg">
								<?php
								$rows=mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM cust_campaign_details as b, cust_vinyler_dashboard as c , cust_drivers as d  where 
								b.camp_id=d.driv_camp_id AND b.camp_status='0' 
								AND b.camp_active_status='1' AND c.active_or_inactive='2' AND c.vd_camp_id=b.camp_id AND
								b.camp_end_date >= '$myDate' "));
