        ...
        <div class="warper container-fluid">
             ...
             <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">In completed Advertiser Profile</div>
                        <div class="panel-body table-responsive">
                        	...
                        	<table class="table table-bordered">
								...
								$sql="select  a.adv_id,a.adv_name,a.adv_email,a.adv_contact,a.adv_date,a.adv_brand,a.adv_category,a.adv_date from cust_advertiser_info as a ,cust_campaign_details as b where a.adv_id=b.camp_adv_id AND b.camp_id='' limit 50";
           ...
           <a href="adv_in_comp_profile_download.php" class="btn btn-purple btn-md">Download</a>
