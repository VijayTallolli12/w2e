...
$camp_id=$_GET['id'];
	...
	//	$sql="SELECT *  FROM  cust_campaign_details where camp_id='$camp_id' ";
		...
		where a.adv_id=b.camp_adv_id AND b.camp_id='$camp_id'";
		...
		$mail->send(); 
				...
				$sql1="DELETE a.*, b.* 
				FROM cust_campaign_details a 
				LEFT JOIN cust_camp_payment_details b 
				...
				if($query==true)
				{
					echo '<script type="text/javascript">alert("Deleted Successfully"); location.href="pending_camp_for_adv.php";</script>';
				}
									?>