             ...
             <div class="row">           	
                ...
                <div class="col-md-12">                
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Pending Vinyl Wrapping:</div>
...
<br><table class="table table-bordered order-table table">
								...
								ON p.vd_camp_id = e.camp_id limit $start,$limit";
								...
								$sl++;
                                  ...
                                  <tr>
									...
									<?php 
									if($row["vd_camp_id"]==$row["camp_id"] )
									{
										?>
										<td>Vinyl Has Sent</td>
									<?php
									...
									{
										?>
									<td><input type="submit" name="vinyl" value='SENT'  disabled class="btn btn-danger" ></td>
									<?php
									}
									 else if($camp_no_cars != $no_of_camp_id){ 
									 
									 ?>
									
										<td><input type="submit" name="vinyl" value='NOT YET' disabled   class="btn btn-success" ></td>
									<?php
									}
									else
									{
									...
									?>
									<td><input type="submit" name="vinyl" value='SEND'   class="btn btn-success" ></td>
										<?php
									}
									?>
                                  </tr>
              ...
              <a href="adv_vth_in_active_campain_download.php" class="btn btn-purple btn-md">Download</a>
...
function display()
{
	 ...
	 if(g != "" && h != "")
	 {
		 var url="adv_vthlie.php?da="+g+"&te="+h;
